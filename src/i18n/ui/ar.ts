...
export const ar: UIDictionary = {
  'tab.scan': 'مسح',
  'scan.title': 'امسح الملصق',
  'scan.subtitle': 'وجّه الكاميرا إلى الباركود لفحص منتج معلّب.',
  'scan.permissionTitle': 'الوصول إلى الكاميرا',
  'scan.permissionBody': 'يحتاج التطبيق إلى الكاميرا لقراءة الباركود. لا يُسجَّل شيء ولا يُرفَع.',
  'scan.permissionButton': 'السماح بالكاميرا',
  'scan.permissionDenied': 'الوصول إلى الكاميرا مغلق. فعّله من الإعدادات › KetoInSeven.',
  'scan.aim': 'حاذِ الباركود داخل الإطار',
  'scan.looking': 'جارٍ البحث…',
  'scan.scanAgain': 'امسح منتجًا آخر',
  'scan.notFoundTitle': 'غير موجود في قاعدة البيانات',
  'scan.notFoundBody': 'لم يسبق لـ Open Food Facts رؤية هذا الباركود. التغطية أقل خارج أوروبا.',
  'scan.offlineTitle': 'تعذّر الوصول إلى قاعدة البيانات',
  'scan.offlineBody': 'يحتاج البحث إلى إنترنت. تحقّق من اتصالك وحاول مجددًا.',
  'scan.errorTitle': 'فشل البحث',
  'scan.errorBody': 'ردّ Open Food Facts بخطأ. حاول بعد قليل.',
  'scan.verdictKeto': 'مناسب للكيتو',
  'scan.verdictBorderline': 'على الحدّ',
  'scan.verdictAvoid': 'غير مناسب للكيتو',
  'scan.verdictUnknown': 'المعلومات غير كافية',
  'scan.per100g': 'لكل 100 غ',
  'scan.perServing': 'للحصة الواحدة',
  'scan.servingOf': 'حصة {count} غ',
  'scan.netCarbs': '{count} غ صافية',
  'scan.whyTitle': 'لماذا',
  'scan.reasonNoCarbs': 'لا توجد قيمة كربوهيدرات في هذا السجل، فلا شيء للحكم عليه.',
  'scan.reasonLowDensity': '{count} غ كربوهيدرات لكل 100 غ — منخفضة بما يكفي لتناولها بحرية.',
  'scan.reasonMidDensity': '{count} غ كربوهيدرات لكل 100 غ — مقبولة بكمية محسوبة.',
  'scan.reasonHighDensity': '{count} غ كربوهيدرات لكل 100 غ — أعلى من أن تكون أساسًا في الكيتو.',
  'scan.reasonSmallServing': 'الحصة الواحدة {count} غ كربوهيدرات، جزء صغير من يومك البالغ {limit} غ.',
  'scan.reasonMidServing': 'الحصة الواحدة {count} غ كربوهيدرات — جزء ملحوظ من يومك البالغ {limit} غ.',
  'scan.reasonBigServing': 'الحصة الواحدة {count} غ كربوهيدرات مقابل يوم من {limit} غ.',
  'scan.reasonSugars': 'منها {count} غ سكريات.',
  'scan.reasonSugarFirst': 'السكر من أوائل المكوّنات.',
  'scan.reasonSugarListed': 'السكر مذكور ضمن المكوّنات.',
  'scan.reasonFibre': 'الألياف تخفضها إلى {count} غ صافية ({fibre} غ ألياف).',
  'scan.source': 'البيانات من Open Food Facts',
  'scan.disclaimer': 'بيانات الملصقات يساهم بها المستخدمون وقد تكون خاطئة أو قديمة. راجع العبوة.',
  ...
  'shopping.forPeople': 'التسوّق لـ',
  'shopping.peopleOne': 'شخص واحد',
  'shopping.peopleMany': '{count} أشخاص',
  'shopping.fewerPeople': 'عدد أقل من الأشخاص',
  'shopping.morePeople': 'عدد أكبر من الأشخاص',
